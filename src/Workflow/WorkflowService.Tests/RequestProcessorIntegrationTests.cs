...
namespace Fabrikam.Workflow.Service.Tests
{
    ...
    {
        private const string DeliveryPath = "/DroneDelivery/DeliveryService";
        private const string DroneSchedulerPath = "/droneschedulerapp/droneschedulerservice";
        private const string PackagePath = "/packageapp/packageservice";
